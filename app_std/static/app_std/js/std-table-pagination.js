/**
 * STD table pagination — identical markup/classes to app_access access_table_pagination.html
...
(function () {
        ...
        container.innerHTML =
            ...
            '<div class="d-flex flex-wrap align-items-center gap-3">' +
                '<div class="d-flex align-items-center page-size-selector">' +
                    ...
                    '</label>' +
                    '<select class="form-select form-select-sm std-table-page-size-select" ' +
                        'id="' + escapeHtml(selectId) + '" data-std-page-size-select ' +
    ...
    function bindPaginationEvents(container, handlers) {
        if (container._stdPaginationBound) {
            return;
        }
        container._stdPaginationBound = true;
        ...
        container.addEventListener('change', function (e) {
            if (!e.target.matches('[data-std-page-size-select]')) {
                return;
            }
    ...
    window.initStdDataTablePagination = function (options) {
        var api = options.api;
