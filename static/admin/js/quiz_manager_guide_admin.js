/**
 * Quiz Manager Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.QUIZ_MANAGER_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.quiz-manager-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="quiz-manager-guide-translate-btn button">')
