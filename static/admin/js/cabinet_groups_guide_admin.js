/**
 * Cabinet Groups Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.CABINET_GROUPS_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.cabinet-groups-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="cabinet-groups-guide-translate-btn button">')
