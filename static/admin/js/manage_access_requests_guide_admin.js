/**
 * Manage Access Requests Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.MANAGE_ACCESS_REQUESTS_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.manage-access-requests-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="manage-access-requests-guide-translate-btn button">')
