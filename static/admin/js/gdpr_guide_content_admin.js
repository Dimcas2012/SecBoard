/**
 * GDPR Guide Content admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.GDPR_GUIDE_CONTENT_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.gdpr-guide-content-translate-btn').length) return;

            var $btn = $('<button type="button" class="gdpr-guide-content-translate-btn button">')
