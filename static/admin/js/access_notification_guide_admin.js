/**
 * Access Notification Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.ACCESS_NOTIFICATION_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.access-notification-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="access-notification-guide-translate-btn button">')
