/**
 * Risk Report Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.RISK_REPORT_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.risk-report-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="risk-report-guide-translate-btn button">')
