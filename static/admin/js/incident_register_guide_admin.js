/**
 * Incident Register Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.INCIDENT_REGISTER_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.incident-register-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="incident-register-guide-translate-btn button">')
