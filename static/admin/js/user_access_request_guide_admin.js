/**
 * User Access Request Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.USER_ACCESS_REQUEST_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.user-access-request-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="user-access-request-guide-translate-btn button">')
