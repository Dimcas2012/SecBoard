/**
 * Access Records Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.ACCESS_RECORDS_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.access-records-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="access-records-guide-translate-btn button">')
