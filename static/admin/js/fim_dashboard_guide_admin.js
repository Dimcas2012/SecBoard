/**
 * FIM Dashboard Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.FIM_DASHBOARD_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.fim-dashboard-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="fim-dashboard-guide-translate-btn button">')
