/**
 * Mandatory Processes Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.MANDATORY_PROCESSES_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.mandatory-processes-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="mandatory-processes-guide-translate-btn button">')
