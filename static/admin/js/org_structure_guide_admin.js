/**
 * Organization Structure Guide admin: "Translate from base" for Guide translations (TinyMCE content).
 */
(function() {
    'use strict';
    ...
    function initTranslateButtons() {
        ...
        var $ = django.jQuery;
        var translateUrl = window.ORG_STRUCTURE_GUIDE_TRANSLATE_URL;
        ...
        $('.inline-related').each(function() {
            ...
            if (!contentId) return;
            if ($row.find('.org-structure-guide-translate-btn').length) return;

            var $btn = $('<button type="button" class="org-structure-guide-translate-btn button">')
