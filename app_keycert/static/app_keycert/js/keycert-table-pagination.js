/**
 * Keycert table pagination — identical markup/classes to app_access access_table_pagination.html
...
(function () {
        ...
        container.innerHTML =
            ...
            '<div class="d-flex flex-wrap align-items-center gap-3">' +
                '<div class="d-flex align-items-center page-size-selector">' +
                    ...
                    '</label>' +
                    '<select class="form-select form-select-sm keycert-table-page-size-select" ' +
                        'id="' + escapeHtml(selectId) + '" data-keycert-page-size-select ' +
    ...
    function bindPaginationEvents(container, handlers) {
        if (container._keycertPaginationBound) {
            return;
        }
        container._keycertPaginationBound = true;
        ...
        container.addEventListener('change', function (e) {
            if (!e.target.matches('[data-keycert-page-size-select]')) {
                return;
            }
    ...
    window.initKeycertDataTablePagination = function (options) {
        var api = options.api;
