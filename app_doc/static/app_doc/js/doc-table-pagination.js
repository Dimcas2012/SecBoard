/**
 * Doc table pagination — identical markup/classes to app_access access_table_pagination.html
...
(function () {
        ...
        container.innerHTML =
            ...
            '<div class="d-flex flex-wrap align-items-center gap-3">' +
                '<div class="d-flex align-items-center page-size-selector">' +
                    ...
                    '</label>' +
                    '<select class="form-select form-select-sm doc-table-page-size-select" ' +
                        'id="' + escapeHtml(selectId) + '" data-doc-page-size-select ' +
    ...
    function bindPaginationEvents(container, handlers) {
        if (container._docPaginationBound) {
            return;
        }
        container._docPaginationBound = true;
        ...
        container.addEventListener('change', function (e) {
            if (!e.target.matches('[data-doc-page-size-select]')) {
                return;
            }
    ...
    window.initDocDataTablePagination = function (options) {
        var api = options.api;
